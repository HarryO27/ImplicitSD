function [X, out]= ImplicitSD_sphere(X, fun, opts, varargin)
%-------------------------------------------------------------------------
...
%                 Calling syntax:
%                   [X, out]= ImplicitSD_sphere(X0, @fun, opts, data1, data2);
%
...
% tic; [X, out]= ImplicitSD_sphere(X0, @fun, opts, A); tsolve = toc;
